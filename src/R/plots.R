...
plot_return_histogram <- function(returns, symbol, gts_sample = NULL) {
  ...
  legend("topright", legend = c("Normal", "GTS"), col = c("#1f78b4", "#e31a1c"), lwd = 2, bty = "n", cex = 0.85)
}
...
plot_qq_comparison <- function(returns, symbol, gts_grid = NULL) {
  ...
  grid(col = "gray90")
  legend("bottomright", legend = c("Normal", "GTS"), col = c("#1f78b4", "#e31a1c"), pch = 16, bty = "n", cex = 0.85)
}
